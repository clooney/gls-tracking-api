GLS Tracking API - .Net
================================
Use .Net to track GLS shipments with GLS Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "JJFI67594498944072936";
                  createTrackingParams.courierCode = "gls";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "364123734778,65561557219";
                  getTrackingResultsParams.courierCode = "gls";
